...
export const auditLog = pgTable("audit_log", {
  ...
  action: varchar("action").notNull(), // created | recheck_committed | status_change | imported | import_summary | exported | employee_updated | delete_attempt | tracker_snapshot | stock_corrected
